import { Box, Typography, IconButton, Modal, TableContainer, Table, TableHead, TableRow, TableCell, TableBody, Button, Chip, TextField, InputAdornment, Avatar, CircularProgress, Alert } from "@mui/material";
    ...
    >
      ...
      >
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
          Choose internal users to add as meeting attendants.
        </Typography>
